			...
			<div id="contenido">
				<div class="contenedorP">
                    <table width="100%" border="1" style="color:white; text-align:center;" >
                        <tr style="background-color:black;"><td>ID del Video</td><td>Nombre</td><td>Subtema</td><td>URL</td></tr>

                        <?php
						$consulta=mysqli_query($conexion,"SELECT * FROM videos ");
                ...
                <br>
                    ...
                    <br>
               		<form method="POST">
                        ...
                        <br>
						<input type="submit" name="agregar_video" id="agregar_video" value="Agregar Video"/><br><br>
						<br>
						<h4>Eliminar Video:</h4><br>
						<input type="text" name="id" placeholder="Ingrese id para eliminar"/>
                        <br><br>
						<input type="submit" name="eliminar_video" id="eliminar_video" value="Eliminar Video"/>
					</form>
					<br>
					...
					<?php
						if(isset($_POST['agregar_video'])){
							...
							if($nombre=="" || $subtema=="" || $url==""){
								...
								mysqli_query($conexion,"INSERT INTO videos (id_video, nombre, subtema, URL) 
