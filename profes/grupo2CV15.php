			...
			<div id="contenido">
				<div class="contenedorP">
                    <table width="100%" border="1" style="color:white; text-align:center;" >
                        <tr style="background-color:black;"><td>id</td><td>Nombre</td><td>Usuario</td><td>Correo</td><td>Grupo</td></tr>

                        <?php
						$consulta=mysqli_query($conexion,"SELECT id, nombre, usuario, correo, grupo FROM usuarios WHERE grupo = '2CV15' ORDER BY nombre");
